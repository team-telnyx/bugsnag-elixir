defmodule Bugsnag do
  ...
  defp add_stacktrace(options) when is_map(options) do
    Map.put_new(options, :stacktrace, System.stacktrace())
  end
  ...
  def sync_report(exception, options \\ []) do
    ...
    if should_notify_exception(exception) do
  ...
  defp default_config do
    [
      ...
      ignored_exceptions: {:system, "BUGSNAG_IGNORED_EXCEPTIONS", []}
    ]
  end
